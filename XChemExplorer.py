...
#        self.target_list,self.visit_list=XChemMain.get_target_and_visit_list_for_Pietro(self.beamline_directory)
    ...
    def start_GUI(self):
        ...
        frame_dataset_task.setStyleSheet("QFrame { border: 1px solid green; border-radius: 4px; padding: 1px }")
...
#        dataset_task_run_button.setStyleSheet("QPushButton { border: 1px solid red; border-radius: 4px; padding: 1px }")
        dataset_task_run_button.setStyleSheet("QPushButton { padding: 1px }")
...
#        frame_map_cif_file_task.setStyleSheet("margin: 1px; padding: 1px; border: 1px gray; border-radius: 1px")
        vboxTask=QtGui.QVBoxLayout()
...
#        frame_panddas_file_task.setStyleSheet("margin: 1px; padding: 1px; border: 1px black; border-radius: 1px")
        vboxTask=QtGui.QVBoxLayout()
...
#        frame_refine_file_task.setStyleSheet("margin: 1px; padding: 1px; border: 1px gray; border-radius: 1px")
        vboxTask=QtGui.QVBoxLayout()
