...
class PuckTracker(QtGui.QApplication):
...
#        self.reference_file_root='reference'
    ...
    def start_GUI(self):
        ...
        self.window.setWindowTitle("PuckTracker")
...
#        self.timer = QtCore.QBasicTimer()
    ...
    def open_config_file(self):
        ...
        try:
            ...
            self.update_status_bar('Sorry, this is not a PuckTracker config file!')
