            ...
            if self.submit_mode=='local machine':
                ...
                submission_string = self.remote_string.replace("qsub'",
                                                               str('cd ' +
                                                                   ...
                                                                   '; ' +
                                                                   "qsub -P labxchem -q medium.q -N pandda -pe smp 5 -l exclisive,m_mem_free=100GB pandda.sh'"))
                ...
                os.system('qsub -P labxchem -q medium.q -N pandda -pe smp 5 -l exclusive,m_mem_free=100GB pandda.sh')
